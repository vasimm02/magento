 ...
 */
class Mage_Ind_Model_Shipping_Carrier_Fedex
    extends Mage_Ind_Model_Shipping_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    protected function _formShipmentRequest(Varien_Object $request)
    {
        ...
        $payment_method = $request->getOrder()->getPayment()->getMethodInstance()->getTitle();
            ...
            'RequestedShipment' => array(
                ...
                'RequestedPackageLineItems' => array(
                    ...
                    'SpecialServicesRequested' => array(
                        'SpecialServiceTypes' => $paymentcode,
