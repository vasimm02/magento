...
class Mage_CatalogSearch_Model_Layer extends Mage_Catalog_Model_Layer
{
    ...
    public function prepareProductCollection($collection)
    {
      ...
      $categories = Mage::getResourceModel('catalog/category_collection')
                  ...
                  ->addFieldToFilter('name',$_REQUEST['q']);
      $i=0;
           ...
           foreach($categories as $category)
      {
          ...
          $extra_collection.= implode(",", $category_data->getProductCollection()->getAllIds());
      ...
      if($flag==1)
      {
           $collection_ids = array_merge($collection->getAllIds(),explode(",",$extra_collection));
